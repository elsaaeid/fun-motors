...
@Component({
  selector: 'app-motors', // Updated selector to reflect motors
  templateUrl: './motors.component.html', // Updated template URL
  styleUrls: ['./motors.component.scss'],
})
export class MotorsComponent implements OnInit { // Updated class name
  ...
  public selectedColor: string = 'all';     // Default value for color selection
  public lists: string[] = [
  ...
  private loadProducts(): void {
    ...
    const motorsCategory = productsList.find(category => category.category === 'Motors'); // Updated category to 'Motors'
    this.allProducts = motorsCategory ? motorsCategory.items : []; // Get items from the Motors category
...
@NgModule({
  declarations: [
    MotorsComponent, // Updated declaration to reflect motors component
  ],
  imports: [
    CommonModule,
    FormsModule,
  ...
  bootstrap: [MotorsComponent] // Bootstrap the component if this is the main module
})
